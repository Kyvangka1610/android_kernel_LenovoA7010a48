...
make ARCH=arm64 O=out k5fpr_defconfig;make CC="ccache /home/kyvangka1610/android_prebuilts_gcc_linux-x86_aarch64_aarch64-linux-android-4.9/bin/aarch64-linux-android-gcc" ARCH=arm64 -j2 O=out ;
